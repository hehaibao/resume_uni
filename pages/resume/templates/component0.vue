<template>
	<view class="resume-info tpl0" v-if="resumeInfo">
		<head-custom :addHeight="20" :isBack="isShare ? false : true">
		...
		<view class="body">
			...
			<view class="info-body share">
				...
				<view class="content">
					...
					<view class="evaluate-body body-info border-bottom" v-if="resumeInfo.evaluate_about">
						<view class="header-title">
							<view class="title">
								自我评价
							</view>
					...
					<view class="evaluate-body body-info">
						<view class="header-title">
							<view class="title">
								致谢
							</view>
