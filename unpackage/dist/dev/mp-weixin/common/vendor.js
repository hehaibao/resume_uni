...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"简历小助手","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 25 */
/*!****************************************************!*\
  !*** /Applications/projects/resume_uni/pages.json ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
var k = m({
  ...
  I = m([{"provider":"aliyun","spaceName":"demo","spaceId":"mp-57be0d4d-542b-4c28-ae54-2b409b120e94","clientSecret":"MuvBrcGKA3dfxS0I6r+7tA==","endpoint":"https://api.next.bspapp.com"}]) || [],
  b = true;
var T = "";
try {
  {
...
/* 36 */
/*!*********************************************************************************!*\
  !*** /Applications/projects/resume_uni/pages.json?{"type":"origin-pages-json"} ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  "pages": [{
    ...
    "path": "pages/base-info/base-info"
  }, {
    "path": "pages/school-experience/school-experience"
  }, {
    "path": "pages/school-experience/school-experience-about"
  }, {
    ...
    "path": "pages/work-experience/work-content",
    "style": {
      "navigationBarTitleText": "",
      "enablePullDownRefresh": false
    }
  }, {
    "path": "pages/work-experience/work-performance",
    "style": {
      "navigationBarTitleText": "",
      "enablePullDownRefresh": false
    }
  }, {
    "path": "pages/project-experience/project-experience",
    "style": {
      "navigationBarTitleText": "",
      "enablePullDownRefresh": false
    }
  }, {
    "path": "pages/project-experience/project-describe",
    "style": {
      "navigationBarTitleText": "",
      "enablePullDownRefresh": false
    }
  }, {
    "path": "pages/project-experience/project-achievements",
    "style": {
      "navigationBarTitleText": "",
      "enablePullDownRefresh": false
    }
  }, {
    "path": "pages/professional/professional",
    "style": {
      "navigationBarTitleText": "",
      "enablePullDownRefresh": false
    }
  }, {
    "path": "pages/self-evaluation/self-evaluation",
    "style": {
      "navigationBarTitleText": "",
      "enablePullDownRefresh": false
    }
    ...
    "path": "pages/resume/preview",
    "style": {
      "navigationBarTitleText": "",
      "enablePullDownRefresh": false
    }
  }, {
    "path": "pages/resume-template/resume-template",
    "style": {
      "navigationBarTitleText": "选择简历模板",
      "enablePullDownRefresh": false,
      "onReachBottomDistance": 50
    }
  }],
  "globalStyle": {
    "navigationBarBackgroundColor": "#00d2ca",
    "navigationBarTitleText": "简历小助手",
...
/* 37 */
/*!********************************************************************!*\
  !*** /Applications/projects/resume_uni/pages.json?{"type":"stat"} ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 44 */
/*!********************************************************!*\
  !*** /Applications/projects/resume_uni/util/common.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getDateByYear = getDateByYear;
...
function formatDate() {
  ...
  if (date) {
    ...
    arr[1] = arr[1] - 1;
    date = (0, _construct2.default)(Date, (0, _toConsumableArray2.default)(arr));
  } else {
    date = new Date();
  }
  var o = {
...
function getObjVal(obj, keys) {
  ...
  keys.forEach(function (key) {
    Object.assign(newBbj, (0, _defineProperty2.default)({}, key, obj[key]));
  });
  return newBbj;
}
...
/* 45 */
/*!*****************************************************!*\
  !*** /Applications/projects/resume_uni/util/api.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.wechatLogin = exports.updateResume = exports.getResumeTplList = exports.getResumeList = exports.getResumeById = exports.delResume = exports.addResume = void 0;
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 24));
// 全局请求遮罩
...
var methodsUid = ['getResumeList', 'updateResume', 'addResume', 'delResume'];
var callFunction = function callFunction(name) {
  ...
  return new Promise(function (resolve, reject) {
    var uid = _vue.default.prototype.$store.getters['user/getUid'];
 ...
 */
// 用户登录
var wechatLogin = function wechatLogin(data) {
  return callFunction('wechatLogin', data);
};
// 获取用户简历
exports.wechatLogin = wechatLogin;
var getResumeList = function getResumeList(data) {
  return callFunction('getResumeList', data);
};
// 修改简历
exports.getResumeList = getResumeList;
var updateResume = function updateResume(data) {
  return callFunction('updateResume', data);
};
// 添加简历
exports.updateResume = updateResume;
var addResume = function addResume(data) {
  return callFunction('addResume', data);
};
// 删除简历
exports.addResume = addResume;
var delResume = function delResume(data) {
  return callFunction('delResume', data);
};
// 根据_id获取简历信息
exports.delResume = delResume;
var getResumeById = function getResumeById(data) {
  return callFunction('getResumeById', data);
};
// 获取列表 - 比如：简历模板
exports.getResumeById = getResumeById;
var getResumeTplList = function getResumeTplList(data) {
  return callFunction('queryList', data);
};
exports.getResumeTplList = getResumeTplList;
...
/* 46 */
/*!********************************************************!*\
  !*** /Applications/projects/resume_uni/store/index.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _resume = _interopRequireDefault(__webpack_require__(/*! ./module/resume */ 48));
var _add = _interopRequireDefault(__webpack_require__(/*! ./module/add */ 49));
var _update = _interopRequireDefault(__webpack_require__(/*! ./module/update */ 50));
var _user = _interopRequireDefault(__webpack_require__(/*! ./module/user */ 51));
...
/* 48 */
/*!****************************************************************!*\
  !*** /Applications/projects/resume_uni/store/module/resume.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var resume = {
  ...
  getters: {
    getResumeData: function getResumeData(state) {
      return state.resumeData;
    },
    getResumeByIdData: function getResumeByIdData(state) {
      return function (resumeId) {
        return state.resumeData.find(function (resume) {
  ...
  mutations: {
    setResumeData: function setResumeData(state, data) {
      state.resumeData = data;
    },
    setResumeByIdData: function setResumeByIdData(state, data) {
      var resumeId = data._id;
      var resumeIndex = state.resumeData.findIndex(function (resume) {
        return resume._id == resumeId;
      });
      _vue.default.set(state.resumeData, resumeIndex, data);
    },
    delResumeByIdData: function delResumeByIdData(state, data) {
      var resumeId = data._id;
      var resumeIndex = state.resumeData.findIndex(function (resume) {
        return resume._id == resumeId;
      });
    ...
    updateResumeName: function updateResumeName(state, data) {
      var resumeId = data._id;
      var resume = state.resumeData.find(function (resume) {
        return resume._id == resumeId;
      });
      resume.resume_name = data.resume_name;
    },
    updateResumeTplId: function updateResumeTplId(state, data) {
      var resumeId = data._id;
      var resume = state.resumeData.find(function (resume) {
        return resume._id == resumeId;
      });
...
/* 49 */
/*!*************************************************************!*\
  !*** /Applications/projects/resume_uni/store/module/add.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var resume = {
  ...
  getters: {
    getInfoData: function getInfoData(state) {
      return state.info;
    },
    getSchoolInfoData: function getSchoolInfoData(state) {
      return state.schoolInfo;
    },
    getWorkInfoData: function getWorkInfoData(state) {
      return state.workInfo;
    },
    getProjectInfoData: function getProjectInfoData(state) {
      return state.projectInfo;
    },
    getMajorInfoData: function getMajorInfoData(state) {
      return state.majorInfo;
    },
    getEvaluateInfoData: function getEvaluateInfoData(state) {
      return state.evaluateInfo;
    },
    getResumeInfoData: function getResumeInfoData(state) {
      var info = JSON.parse(JSON.stringify(state.info));
      return _objectSpread(_objectSpread({}, state.info), {}, {
  ...
  mutations: {
    ...
    setSchoolInfoData: function setSchoolInfoData(state, data) {
      state.schoolInfo = data;
    },
    setWorkInfoData: function setWorkInfoData(state, data) {
      state.workInfo = data;
    },
    setProjectInfoData: function setProjectInfoData(state, data) {
      state.projectInfo = data;
    },
    setMajorInfoData: function setMajorInfoData(state, data) {
      state.majorInfo = data;
    },
    setEvaluateInfoData: function setEvaluateInfoData(state, data) {
      state.evaluateInfo = data;
    },
    clearAddData: function clearAddData(state) {
      state = {
        info: {},
        schoolInfo: {},
        workInfo: [],
...
/* 50 */
/*!****************************************************************!*\
  !*** /Applications/projects/resume_uni/store/module/update.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 51 */
/*!**************************************************************!*\
  !*** /Applications/projects/resume_uni/store/module/user.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var user = {
  ...
  mutations: {
    ...
    setToken: function setToken(state, token, tokenExpired) {
      // token
      state.token = token;
...
/* 52 */
/*!**********************************************************!*\
  !*** /Applications/projects/resume_uni/util/validate.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 53 */
/*!********************************************************!*\
  !*** /Applications/projects/resume_uni/util/filter.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  yearFilter: function yearFilter(startYear) {
    return yearInterval(startYear);
  },
  timestamp2Time: function timestamp2Time(timestamp) {
